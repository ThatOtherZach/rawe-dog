...
export function SearchCreditsPanel({
  ...
  async function submitVerify() {
    ...
    setVerifying(true);
    try {
      const result = await verifySearchPayment(quote.quoteId, txHash.trim());
  ...
  return (
    <div className="mb-4 rounded-xl border border-[color-mix(in_srgb,var(--accent)_35%,var(--border))] bg-[#0c0e13] p-4">
      <div className="flex flex-wrap items-center gap-2">
        <span className="text-sm font-semibold">Search credits</span>
